...
def higher_card(card_one, card_two):
    ...
    """
    card_1_value = value_of_card(card_one)
    card_2_value = value_of_card(card_two)

    if card_1_value == card_2_value:
        return card_one, card_two
    
    return card_one if card_1_value>card_2_value else card_two
...
def value_of_ace(card_one, card_two):
    ...
    if card_one == 'A':
        ...
        hand_total += value_of_card(card_one)
    ...
    if card_two == 'A':
        ...
        hand_total += value_of_card(card_two)
